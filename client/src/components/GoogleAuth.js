...
const GoogleAuth = () => {
  ...
  return (
    <>
      <GoogleLogin
        clientId="1076552939698-r8kuiq9rsfcoehtnfn95bveg8aut6762.apps.googleusercontent.com"
        render={(renderProps) => (
          <button
            onClick={renderProps.onClick}
            disabled={renderProps.disabled}
            className="border-2 border-opacity-10 border-richBlack flex space-x-2 rounded bg-semiWhite text-richBlack py-2 px-4 w-full justify-center font-semibold"
          >
            <svg
